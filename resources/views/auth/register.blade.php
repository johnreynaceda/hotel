...
<div class=" p-14">
    <x-jet-authentication-card>
        <x-slot name="logo">
            <h1 class="text-5xl font-bold text-gray-700">REGISTER</h1>
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="middlename" class="block mt-1 w-full" type="text" name="middlename" :value="old('middlename')" required autofocus autocomplete="name" />
            </div>
            <div class="mt-4">
