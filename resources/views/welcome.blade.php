...
<div class="flex mx-24">
    <div class="grid grid-cols-3 gap-3">
        <a href="{{ route('customer-booking') }}" class=" transform transition duration-200 cursor-pointer hover:-translate-y-1 hover:scale-100">
            <div class="bg-gray-700 relative h-64 w-96 shadow-md">
                <img src="{{ asset('images/room1.jpg') }}" class="w-full opacity-75 absolute" alt="">
                <div class=" relative ">
                   <div class="flex flex-col justify-end px-5 bg-gray-900 mt-40 py-2 absolute">
                       <h1 class="text-xl font-bold text-white">Normal Room</h1>
                       <h1 class="text-2xl font-bold text-red-500">&#8369;1,000.00</h1>
                   </div>
                </div>
            </div>
        </a>
        <a href="" class=" transform transition duration-200 cursor-pointer hover:-translate-y-1 hover:scale-100">
            <div class="bg-gray-700 relative h-64 w-96 shadow-md">
                <img src="{{ asset('images/room1.jpg') }}" class="w-full opacity-75 absolute" alt="">
                <div class=" relative ">
                   <div class="flex flex-col justify-end px-5 bg-gray-900 mt-40 py-2 absolute">
